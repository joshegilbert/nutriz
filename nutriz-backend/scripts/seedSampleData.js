...
const seedUserEmail = process.env.SEED_EMAIL || 'coach@nutriz.demo';
...
const sampleRecipes = [
  {
    ...
    description: 'Colourful bowl with lean protein, whole grains, and healthy fats.',
    instructions:
      'Layer quinoa, chicken, and vegetables in a bowl. Top with avocado slices and a squeeze of lemon.',
    tags: ['Lunch', 'Balanced'],
    ingredients: [
      { foodName: 'Grilled Chicken Breast', quantity: 1, amount: '1 serving', notes: 'Sliced' },
      { foodName: 'Quinoa', quantity: 1, amount: '1 cup', notes: 'Cooked' },
      { foodName: 'Baby Spinach', quantity: 1, amount: '2 cups', notes: 'Fresh' },
      { foodName: 'Roasted Sweet Potato', quantity: 1, amount: '1 cup', notes: 'Cubed' },
      { foodName: 'Avocado', quantity: 1, amount: '1/2 medium', notes: 'Diced' },
    ],
  },
  {
    name: 'Recovery Greens Smoothie',
    description: 'Post-training smoothie rich in micronutrients and healthy fats.',
    instructions:
      'Blend spinach with avocado, almond milk, and ice until silky smooth. Garnish with crushed almonds.',
    tags: ['Snack', 'Recovery'],
    ingredients: [
      { foodName: 'Baby Spinach', quantity: 1.5, amount: '3 cups', notes: 'Packed' },
      { foodName: 'Avocado', quantity: 1, amount: '1/2 medium', notes: 'Ripe' },
      { foodName: 'Toasted Almonds', quantity: 0.5, amount: '2 tbsp', notes: 'Crushed' },
    ],
  },
];
...
const sampleClients = [
  {
    ...
    notes: 'Masters triathlete training for a 70.3 event. Prefers plant-forward dinners.',
  },
  {
    name: 'Sofia Bennett',
    dob: '1995-02-03',
    ...
    notes: 'Works rotating shifts. Needs portable breakfast options and batch-friendly lunches.',
  },
];
